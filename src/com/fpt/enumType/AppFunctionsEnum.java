...
public enum AppFunctionsEnum {
    ...
    LIST_FILE_FOLDER_ATTRIBUTES("listFileFolderAttributes", "get files and subdirectories detail from file/folder location (sourcePath) with response status store in variable (undefined)", true),
